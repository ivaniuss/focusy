...
Command: npx gltfjsx@6.5.2 public/cubohueco.gltf 
*/
...
export function Cubohueco2(props) {
  ...
  // const { scene, animations } = useGLTF('/cubohueco.gltf')
  const { scene } = useGLTF('/cubohueco.gltf')
...
useGLTF.preload('/cubohueco.gltf')
